...
public class ResultFinal {
	...
	public enum Filter {
		COMPETITION, BENCHMARK, SAT, 
		I_CLAUSES, I_UCLAUSES, I_BCLAUSES, I_TCLAUSES, I_LCLAUSES, I_RATIO_CX, I_TIME,
	...
	public ResultFinal(ArrayList<Data> results) {
	...
	public static ArrayList<Data> filter (ArrayList<Data> oldDatas, Filter filter, 
		...
		switch (filter) {
			...
			default : 
				System.out.println("Error while filtring.");
				return oldDatas;
		}
	}
	 ...
	 * Sort a list
	 */
	public static ArrayList<Data> sort(ArrayList<Data> oldDatas, Sorter sorter){
